          ...
          success: function(){
            ...
            $.ajax({
              ...
              success: function(msg) {
                ...
                if( msg.showapi_res_body.city && allCityData.some( function(item) { return item === msg.showapi_res_body.city } ) ) {
                  changeCityAjax(msg.showapi_res_body.city, true)     
                }else{
                  changeCityAjax('北京', true)
                }
              },
              error: function(){ changeCityAjax('北京', true) }
            })  
          },
          error: function(){ changeCityAjax('北京', true) }
        })  
  ...
  filters: {
    ...
    indexToWeekDay: function(index) {
      if ( index === 0 ) {
        ...
        switch (num) {
          case 2: case 9:  return "周二";
          case 3: case 10: return "周三";
          case 4: case 11: return "周四";
          case 5: case 12: return "周五";
          case 6:          return "周六";
          case 7:          return "周日";
          case 8:          return "周一"; 
          default:         return "未知";         
    ...
    popToicon: function(num) {
      ...
      return {'background-image':'url(png/'+i+'.png)'}
    },
    //根据input过滤所有城市
